...
class TPAcceptanceProfitSpillUnopenCell extends StatefulWidget {
  TPAcceptanceProfitSpillUnopenCell({Key key,this.didClickItemCallBack,this.listModel}) : super(key: key);
  ...
  @override
  _TPAcceptanceProfitSpillUnopenCellState createState() => _TPAcceptanceProfitSpillUnopenCellState();
}

class _TPAcceptanceProfitSpillUnopenCellState extends State<TPAcceptanceProfitSpillUnopenCell> {
   @override
