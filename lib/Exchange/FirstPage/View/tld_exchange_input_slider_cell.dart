...
class TPExchangeInputSliderCell extends StatefulWidget {
  final String title;
  final TPWalletInfoModel infoModel;
  final Function(String) inputCallBack;
  final FocusNode focusNode;
  TPExchangeInputSliderCell({Key key,this.title,this.infoModel,this.inputCallBack,this.focusNode}) : super(key: key);

  @override
  _TPExchangeInputSliderCellState createState() => _TPExchangeInputSliderCellState();
}

class _TPExchangeInputSliderCellState extends State<TPExchangeInputSliderCell> {
  String _value = '0';
