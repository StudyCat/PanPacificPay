...
class TPPaymentDiyInfoPage extends StatefulWidget {
  TPPaymentDiyInfoPage({Key key,this.walletAddress,this.paymentModel}) : super(key: key);
  ...
  @override
  _TPPaymentDiyInfoPageState createState() => _TPPaymentDiyInfoPageState();
}

class _TPPaymentDiyInfoPageState extends State<TPPaymentDiyInfoPage> {
   List titles;
