...
class TPAcceptanceWithdrawSliderInputCell extends StatefulWidget {
  TPAcceptanceWithdrawSliderInputCell({Key key,this.title,this.inputCallBack,this.focusNode,this.maxValue}) : super(key: key);
  final String title;
  final String maxValue;
  final Function(String) inputCallBack;
  final FocusNode focusNode;
  @override
  _TPAcceptanceWithdrawSliderInputCellState createState() => _TPAcceptanceWithdrawSliderInputCellState();
}

class _TPAcceptanceWithdrawSliderInputCellState extends State<TPAcceptanceWithdrawSliderInputCell> {
 String _value = '0';
