...
class TPDetailRedEnvelopeContentCell extends StatefulWidget {
  TPDetailRedEnvelopeContentCell({Key key,this.reiceveModel}) : super(key: key);

  final TPRedEnvelopeReiceveModel reiceveModel;

  @override
  _TPDetailRedEnvelopeContentCellState createState() => _TPDetailRedEnvelopeContentCellState();
}

class _TPDetailRedEnvelopeContentCellState extends State<TPDetailRedEnvelopeContentCell> {
  @override
