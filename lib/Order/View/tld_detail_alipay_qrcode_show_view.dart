...
class TPDetailAlipayQrCodeShowView extends StatefulWidget {
  TPDetailAlipayQrCodeShowView({Key key,this.qrCode,this.amount}) : super(key: key);
  ...
  @override
  _TPDetailAlipayQrCodeShowViewState createState() => _TPDetailAlipayQrCodeShowViewState();
}

class _TPDetailAlipayQrCodeShowViewState extends State<TPDetailAlipayQrCodeShowView> {
