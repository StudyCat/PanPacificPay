...
class PPMissionDetailOrderBottomCell extends StatefulWidget {
  PPMissionDetailOrderBottomCell({Key key,this.detailOrderModel,this.didClickActionBtnCallBack,this.isBuyer}) : super(key: key);
  ...
  @override
  _PPMissionDetailOrderBottomCellState createState() => _PPMissionDetailOrderBottomCellState();
}

class _PPMissionDetailOrderBottomCellState extends State<PPMissionDetailOrderBottomCell> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        TPClipCommonCell(
          ...
          content: widget.detailOrderModel.profitCount + 'TP',
        ...
        Padding(
          ...
          titleStyle: TextStyle(
              fontSize: ScreenUtil().setSp(24),
              color: Color.fromARGB(255, 51, 51, 51)),
          content: widget.detailOrderModel.profitRate + '%',
          contentStyle: TextStyle(
              fontSize: ScreenUtil().setSp(24),
              color: Color.fromARGB(255, 102, 102, 102)),
        ),
